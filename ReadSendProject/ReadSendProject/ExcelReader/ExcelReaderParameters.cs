...
namespace ReadSendProject.ExcelReader
{
    struct ExcelReaderParameters
    {
        ...
        /// <summary>
        /// Work sheets to be processed, found by index.
        /// If names are also used, duplicates are not eliminated.
        /// </summary>
        public List<int> sheetsIndexes;

        /// <summary>
        /// Index of Excel table header to process, assuming all
        ...
        /// <summary>
        /// List of column indexes that will be checked for expiration date.
        /// </summary>
        public List<int> columnsIndexesToCheckDate;
        ...
        /// <summary>
        /// List of column indexes that will be included in the email.
        /// The columns checked for date are NOT included.
        /// First column in email will contain the sheet and row index of expired row.
        /// </summary>
        public List<int> columnsIndexesToEmail;
    }
}
